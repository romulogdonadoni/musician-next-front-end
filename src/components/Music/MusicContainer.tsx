...
export default function MusicContainer({ name, imageUrl, authorName, musicUrl }: MusicTrack) {
  ...
  return (
    <div
      ...
      className="group/edit flex flex-1  bg-black-700 border border-silver-600 rounded-lg p-2 gap-2 cursor-pointer hover:bg-neutral-600 ease-in-out duration-300  "
    >
